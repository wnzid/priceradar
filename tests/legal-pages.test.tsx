...
describe("footer and information pages",()=>{
  ...
  it("renders contact guidance without inventing an email",()=>{const html=render(<Contact/>);expect(html).toContain("Data correction");expect(html).toContain("Rights-holder request");expect(html).not.toMatch(/contact@|mailto:/)});
